...
//
//        Objectives
//Implement a LabSession1.Task1.User Class: Create a LabSession1.Task1.User class encapsulating common attributes and behaviors for all users. This class should include:
//
...
//Implement a Student Subclass: Develop a Student class that extends the LabSession1.Task1.User class, adding specific properties and functionalities for student users. This class should include:
//
...
//A constructor to initialize both the inherited properties from LabSession1.Task1.User and the new properties specific to Student.
...
//Implement an Employee Subclass: Create an Employee class that also extends the LabSession1.Task1.User class, tailored for employee users. This class should include:
//
...
//A constructor to initialize both the inherited properties from LabSession1.Task1.User and the new properties specific to Employee.
